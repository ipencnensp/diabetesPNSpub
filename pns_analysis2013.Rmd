...
```{r}
saveRDS(x, file = "distribuicaoNAsrisco2013_20230505.rds", compress = TRUE)
```
...
pontos_genero13.df <- pontos_genero2013 %>% 
  filter(risco == 1) %>%
  mutate(one = round(one,0),
...
pontos_2013.df <- bind_rows(pontos_fxeta2_2013.df,pontos_race_2013.df,pontos_fxesc_2013.df,pontos_imc_2013.df,pontos_hypert_2013.df)
```
...
```{r eval = FALSE}
saveRDS(pontos_2013.df, file = "pontos_2013_20230505.rds", compress = TRUE)
```
